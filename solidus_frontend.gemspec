...
Gem::Specification.new do |s|
  ...
  s.metadata['source_code_uri'] = 'https://github.com/gsmendoza/solidus_frontend'
  s.metadata['changelog_uri'] = 'https://github.com/gsmendoza/solidus_frontend/blob/master/CHANGELOG.md'
